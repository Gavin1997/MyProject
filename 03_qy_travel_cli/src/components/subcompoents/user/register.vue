             ...
             <div class="login-wrapper">
                 ...
                 <div class="login-section mt-3">
                    ...
                    <div class="input_list">
                        <span>用户名:</span><input type="text" v-focus placeholder="请输入您的用户名" maxlength="12" class="my-form-control1 mt-5" name="uname" v-model="uname" @blur.prevent="blur_uname">
                        <span class=" input_list_prompt" :class="unameClass" v-text="isuname.msg" :style="show"></span>
                    </div>
                    <div class="input_list">
