...
(7,'泰国进口 金枕头榴莲 泰国进口 香出新高度','榴莲是驰名的优质佳果。成熟果肉浅黄，黏性多汁，酥软味甜，吃起来具有陈乳酪和洋葱味，初尝似有异味，续食清凉甜蜜，回味甚佳，故有“流连（榴莲）忘返”的美誉。别名又叫韶子。它原产于东南亚，被称为“万果之王”。榴莲成熟后自己落下，通常都是在深夜或清晨掉落。',1800,1300,96.9,139.9,'http://127.0.0.1:3333/img/product/liulan.jpg'),
(8,'心扉鲜果礼盒 (进口苹果鲜橙龙眼)','每一口都是味蕾的享受',800,500,59.9,109.0,'http://127.0.0.1:3333/img/product/longyan.png'),
(9,'Mom 的 Love 鲜果礼盒','给妈妈的一份微薄的爱,从简单的水果开始,心里甜蜜蜜,就如苹果一般',5000,1000,199.9,268.0,'http://127.0.0.1:3333/img/product/lihe.jpg'),
-- -- 精选
(10,'河阴石榴','河阴石榴,甜蜜蜜到心里',2000,800,29.9,59.9,'http://127.0.0.1:3333/img/index/cherry.png'),
(11,'大块石榴,红心石榴,甜到心里','性味甘、酸涩、温，具有杀虫、收敛、涩肠、止痢等功效。石榴果实营养丰富，维生素C含量比苹果、梨要高出一二倍。',2000,500,49.9,59.9,'http://127.0.0.1:3333/img/product/shiliu.jpg'),
(12,'墨西哥进口牛油果','牛油果的果实是一种营养价值很高的水果，含多种维生素、丰富的脂肪酸和蛋白质和高含量的钠、钾、镁、钙等元素，营养价值可与奶油媲美，甚至有“森林奶油”的美称，一般作为生果食用，也可被制作为菜肴和罐头。',1500,500,36.9,59.9,'http://127.0.0.1:3333/img/product/niuyopguo.jpg'),
(13,'顺丰包邮 陕西户木紫葡萄,红心石榴,甜到心里','葡萄堪称水果界的美容大王，它的果肉、果汁和种子内都含有许多对肌肤有益的营养成分，它具有抗氧化、防皱和除皱等功效，还能让肌肤保湿，让肤色变得更加水润透亮，此外，葡萄中所含的多酚可保护肌肤，令肌肤再生，使肌肤更有弹性。',2200,400,112.9,159.9,'http://127.0.0.1:3333/img/product/putao.jpg'),

-- 新品
(14,'山竹果后','水果王国的 山竹果后 爽口顺滑,清甜多汁',1000,1000,1000,1000,'http://127.0.0.1:3333/img/index/shanzu.png'),
(15,'山竹果 进口泰国 原汁原味','山竹壳厚硬呈紫色，肉雪白嫩软，味甜略带酸，非常可口，并被称为水果女皇.',1000,200,69.9,89.9,'http://127.0.0.1:3333/img/product/aiqiguo.jpg'),
(16,'顺丰包邮 陕西户木紫葡萄,红心石榴,甜到心里','葡萄堪称水果界的美容大王，它的果肉、果汁和种子内都含有许多对肌肤有益的营养成分，它具有抗氧化、防皱和除皱等功效，还能让肌肤保湿，让肤色变得更加水润透亮，此外，葡萄中所含的多酚可保护肌肤，令肌肤再生，使肌肤更有弹性。',2200,400,112.9,159.9,'http://127.0.0.1:3333/img/product/putao.jpg'),
(17,'红苹果,如少女的脸庞,粉里透红','道教把苹果视为仙果，它也是北欧神话中的青春之果，是希腊神话中的爱情之果,平平安安,幸幸福福',1200,500,89.9,100.9,'http://127.0.0.1:3333/img/product/apple.jpg');
...
(null,'爱奇果,进口泰国山竹1.5Kg装 中大国 新鲜山竹3斤 进口热带水果',69.90,89.90,'http://127.0.0.1:3333/img/product/aiqiguo.jpg','http://127.0.0.1:3333/img/product/lg/shanzu.jpg'),
